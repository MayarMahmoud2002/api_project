...
class DioConsumer extends ApiConsumer {
  ...
  Future get(String path,
    ...
    try {
      final response =
          await dio.get(path, data: isFormData ? FormData.fromMap(data) : data, queryParameters: queryParams);
      print(response.toString());
    } on DioException catch (e) {
      HandleExceptions(e);
    }
  ...
  Future post(
    ...
    try {
      final response =
          await dio.post(path, data:isFormData? FormData.fromMap(data) : data, queryParameters: queryParams);
      print(response.toString());
    } on DioException catch (e) {
      HandleExceptions(e);
    }
